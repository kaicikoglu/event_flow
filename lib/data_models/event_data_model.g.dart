...
List<IsarLinkBase<dynamic>> _eventGetLinks(Event object) {
  return [object.announcements, object.forumTopics];
}
...
extension EventQueryFilter on QueryBuilder<Event, Event, QFilterCondition> {
  ...
  QueryBuilder<Event, Event, QAfterFilterCondition> participantsEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Event, Event, QAfterFilterCondition> participantsGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Event, Event, QAfterFilterCondition> participantsLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Event, Event, QAfterFilterCondition> participantsBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Event, Event, QAfterFilterCondition> participantsStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Event, Event, QAfterFilterCondition> participantsEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Event, Event, QAfterFilterCondition> participantsContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Event, Event, QAfterFilterCondition> participantsMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
...
extension EventQuerySortBy on QueryBuilder<Event, Event, QSortBy> {
  ...
  QueryBuilder<Event, Event, QAfterSortBy> sortByParticipants() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'participants', Sort.asc);
    });
  }

  QueryBuilder<Event, Event, QAfterSortBy> sortByParticipantsDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension EventQuerySortThenBy on QueryBuilder<Event, Event, QSortThenBy> {
  ...
  QueryBuilder<Event, Event, QAfterSortBy> thenByParticipants() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'participants', Sort.asc);
    });
  }

  QueryBuilder<Event, Event, QAfterSortBy> thenByParticipantsDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'participants', Sort.desc);
    });
  }
...
extension EventQueryWhereDistinct on QueryBuilder<Event, Event, QDistinct> {
  ...
  QueryBuilder<Event, Event, QDistinct> distinctByParticipants(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'participants', caseSensitive: caseSensitive);
    });
  }
...
extension EventQueryProperty on QueryBuilder<Event, Event, QQueryProperty> {
  ...
  QueryBuilder<Event, String, QQueryOperations> participantsProperty() {
    return QueryBuilder.apply(this, (query) {
